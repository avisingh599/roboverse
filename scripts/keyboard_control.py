...
action_commands = {bullet.p.B3G_LEFT_ARROW: np.array([0.1, 0, 0, 0, 0, 0, 0]),
...
def keyboard_control(args):
    ...
    while True:
        ...
        for qKey in keys:
            if qKey in action_commands.keys():
                action += action_commands[qKey]
                take_action = True
...
if __name__ == '__main__':
    ...
    parser.add_argument("-e", "--env-name", type=str, default='Widow250MultiTaskGrasp-v0')
